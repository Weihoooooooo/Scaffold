package com.jcweiho.scaffold.generator;
...
//                    .moduleName("untitled")//模块名称
                    ...
                    .pathInfo(Collections.singletonMap(OutputFile.mapperXml, System.getProperty("user.dir") + (javaModuleName.isEmpty() ? "" : "/" + javaModuleName) + "/src/main/resources/mapper/" + javaModuleName.substring(javaModuleName.indexOf('-') + 1) + "/"));
